...
export declare type ModifiableRange = {
    /**
...
export declare type FixedRange = {
    /**
     * If `true`, the range is a maximum range.
     */
    is_maximum?: true;
 ...
 */
export declare type CheckResultBasedRange = CheckResultBased & {
    /**
 ...
 * @minProperties 1
 */
export declare type RangeTranslation = {
    /**
