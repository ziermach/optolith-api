 ...
 */
export declare type AnimalShapePath = {
    /**
...
export declare type AnimalShapePathTranslation = {
    /**
     * The animal shape path's name.
     */
    name: NonEmptyString;
};
export declare const validateSchema: import("../../../validation/schema.js").TypeValidator<AnimalShapePath>;
