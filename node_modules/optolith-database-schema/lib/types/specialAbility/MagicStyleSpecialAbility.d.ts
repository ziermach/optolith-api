...
export declare type MagicStyleSpecialAbilityTranslation = {
    name: Activatable.Name;
    name_in_library?: Activatable.NameInLibrary;
    rules: Activatable.Rules;
    errata?: Errata;
};
export declare const validateSchema: import("../../validation/schema.js").TypeValidator<MagicStyleSpecialAbility>;
