...
export declare type PactGiftPermanentDemonicConsumption = {
    tag: "Fixed";
    fixed: FixedPactGiftPermanentDemonicConsumption;
} | {
    tag: "PerLevel";
    per_level: PactGiftPermanentDemonicConsumptionPerLevel;
};
export declare type FixedPactGiftPermanentDemonicConsumption = {
    /**
...
export declare type PactGiftPermanentDemonicConsumptionPerLevel = {
    /**
...
export declare type AutomaticEntry = {
    /**
...
export declare type AutomaticEntryTarget = {
    ...
    tag: "Fixed";
    fixed: FixedAutomaticEntryTarget;
};
...
export declare type PactGiftTranslation = {
    name: Activatable.Name;
    name_in_library?: Activatable.NameInLibrary;
    effect: Activatable.Effect;
    errata?: Errata;
};
export declare const validateSchema: import("../../validation/schema.js").TypeValidator<PactGift>;
