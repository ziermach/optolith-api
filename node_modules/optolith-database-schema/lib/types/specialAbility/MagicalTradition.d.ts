 ...
 */
export declare type MagicalTradition = {
    id: Activatable.Id;
...
export declare type MagicalTraditionTranslation = {
...
export declare const validateSchema: import("../../validation/schema.js").TypeValidator<MagicalTradition>;
