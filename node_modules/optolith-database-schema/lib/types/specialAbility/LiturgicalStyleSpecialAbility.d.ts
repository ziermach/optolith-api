 ...
 */
export declare type LiturgicalStyleSpecialAbility = {
    id: Activatable.Id;
...
export declare type LiturgicalStyleSpecialAbilityTranslation = {
    name: Activatable.Name;
    name_in_library?: Activatable.NameInLibrary;
    rules: Activatable.Rules;
    errata?: Errata;
};
export declare const validateSchema: import("../../validation/schema.js").TypeValidator<LiturgicalStyleSpecialAbility>;
