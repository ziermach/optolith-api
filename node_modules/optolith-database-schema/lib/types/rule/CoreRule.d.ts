...
export declare type CoreRuleTranslation = {
    /**
...
export declare type ContentNode = {
    ...
    tag: "ReferenceList";
    reference_list: ReferenceListNode;
};
/**
...
export declare type TextNodeTranslation = {
    /**
 ...
 */
export declare type ReferenceListNode = {
...
export declare type ReferenceListNodeImprovementCostSource = {
    /**
...
export declare const validateSchema: import("../../validation/schema.js").TypeValidator<CoreRule>;
