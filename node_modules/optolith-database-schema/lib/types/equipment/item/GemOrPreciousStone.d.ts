...
export declare type GemOrPreciousStone = {
    /**
...
export declare type GemOrPreciousStoneTranslation = {
    /**
...
export declare const validateSchema: import("../../../validation/schema.js").TypeValidator<GemOrPreciousStone>;
